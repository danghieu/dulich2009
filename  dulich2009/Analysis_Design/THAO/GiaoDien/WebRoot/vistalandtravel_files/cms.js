...
function flashShow(url,width,height){
	<!--
	document.writeln('<OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" WIDTH="'+width+'" HEIGHT="'+height+'" id="movie" ALIGN="">');
	document.writeln('<param name="movie" value="'+url+'" />');
	document.writeln('<param name="quality" value="high" />');
	document.writeln('<param NAME="wmode" VALUE="opaque">');
	document.writeln('<embed src="'+url+'" wmode="opaque" quality="high" bgcolor="#FFFFFF"  WIDTH="'+width+'" HEIGHT="'+height+'" NAME="movie" ALIGN="" TYPE="application/x-shockwave-flash" PLUGINSPAGE="http://www.macromedia.com/go/getflashplayer"></embed>');
...
function open_window(the_url, width, height){
	...
	var new_win = window.open(the_url, "", "toolbar=0,location=0,status=1,menubar=0,titlebar=no,scrollbars=1,resizable=1,width="+ width +",height="+ height +", top="+ top_val +",left="+ left_val);
}
function open_verisign(the_url, width, height){
	...
	newwin = open(the_url, '_blank', winDef);
	//var new_win = window.open(the_url, "",winDef);
}
