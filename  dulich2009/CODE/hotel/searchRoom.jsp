...
<head>
  ...
  <script type="text/javascript" src="<html:rewrite page='/js/datepickercontrol.js'/>"></script>
  <link type="text/css" rel="stylesheet" href="<html:rewrite page='/css/datepickercontrol_bluegray.css'/>">
  <link type="text/css" rel="stylesheet" href="<html:rewrite page='/css/content.css'/>">
  <script language="JavaScript">
  function abc()
  {
  	var date = new Date();
	cal8 = document.getElementById("beginDate");
	cal8.setMinDate(date.toString());
  }
...
<form name="form1" action="/bookRoomInfo?action=searchRoom">
