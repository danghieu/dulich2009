...
<html>
  <head>
    ...
    <title>My JSP 'HotelBody.jsp' starting page</title>
  ...
  <tr>
	...
	<table width="605" border="0" cellpadding="0" cellspacing="0" height="212">
                                ...
                                <tr>
                                  ...
                                  <td><select name="vitri" id="v" style="width: 140px;" class="text_form_search" onChange="javascript:ajaxLoadURL('loader.php?mod=services&amp;act=city&amp;q='+this.value,'GET','','city',2,2);s_cat_id.value=this.value;">
								  <option value=""> Lựa chọn</option>
...
<img src="vistalandtravel_files/icon_calendar.jpg" alt="" onClick="popUpCalendar(this,document.getElementById('dchkout'), 'mm/dd/yyyy', fnSetDate);" align="absbottom" border="0">								  </td>
  ...
  <table width="605" height="110">
          <tbody><tr>
            <td width="85" height="63"><input name="room1_facilities" value="20" type="checkbox">Quầy bar</td>
              <td width="144"><input name="room1_facilities" value="17" type="checkbox">Phòng tập đa năng</td>
              <td width="90"><input name="room1_facilities" value="5" type="checkbox">Bể bơi</td>
              <td width="112"><input name="room1_facilities" value="3" type="checkbox">Mạng internet</td>
              <td width="150"><input name="room1_facilities" value="21" type="checkbox">Phòng hội thảo</td>
          </tr>
          <tr>
            <td height="39"><input name="room1_facilities" value="24" type="checkbox">Nhà hàng</td>
              <td><input name="room1_facilities" value="4" type="checkbox">
              Dịch vụ y tế </td>
              <td><input name="room1_facilities" value="9" type="checkbox">Khu để xe</td>
              <td><input name="room1_facilities" value="31" type="checkbox">Sân tennis</td>
              <td><input name="room1_facilities" value="8" type="checkbox">Câu lạc bộ đêm</td>
          </tr>
</tbody></table>
  </td>
  ...
  <table width="584" height="40">
          <tbody><tr>
           <td width="154">&nbsp;</td>
                                  <td width="69"><input name="s_submit" src="vistalandtravel_files/bt_search.jpg" type="image" border="0" /></td>
  ...
  <tr valign="top"> 
    ...
    <td width="663" bgcolor="#73baff"><div align="center"> 
        <table border="0" cellpadding="0" cellspacing="0" width="75%">
          ...
          <tr> 
            <td><div align="center"><img src="hotel_files/urlwww.jpg" height="41" width="303"></div></td>
          </tr>
        </tbody></table>
      </div></td>
  </tr>
  ...
  <tr> 
    <td><table align="right" bgcolor="#5ebb03" border="0" cellpadding="4" cellspacing="1" width="108%">
        <tbody><tr><td><table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody><tr><td height="150" bgcolor="#ffffff"><div align="center"><strong>Thông tin khách sạn chưa được cập nhật</strong></div></td></tr></tbody></table></td></tr>
      </tbody></table></td>
  </tr>
  <tr>
    <td height="5"><img src="hotel_files/pixel_1_1.gif" height="1" width="1"></td>
