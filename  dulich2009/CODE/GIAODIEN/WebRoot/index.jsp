...
<table width="200" border="1">
  <tr>
    <td><table width="984" border="0">
<tr>
			<td width="974" valign="top" nowrap="nowrap"> <jsp:include page="header.jsp" flush="false"></jsp:include></td>
  </tr>
  ...
  <tr>
    <td><jsp:include page="footer.jsp" flush="false"></jsp:include></td>
  </tr>
