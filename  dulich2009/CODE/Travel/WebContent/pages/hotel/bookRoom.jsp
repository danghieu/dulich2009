        ...
        <tbody><tr> 
          <td valign="top" align="left"><form action="hotelbooking.asp" method="post" name="order" id="form1">
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <td valign="top" align="center"><table width="100%" bgcolor="#e3e1b7" border="1" cellpadding="5" cellspacing="0">
                      ...
                      <tr> 
                        ...
                        <td bgcolor="#FFFFFF" COLSPAN=2> <select name="roomType" size="1" id="roomType" onchange="choseRoomType()" >
                          ...
                          <span  id="lblRoomType" >Loai giường </span>
                          ...
                          <input  name="quantity" id="quantity" size="10" type="text" value="số lượng" onclick="empty()"/>                          </td>
                      </tr>
                ...
                <tr> 
                  <td valign="middle" align="center" height="50"><div align="justify">
                    <p><strong>Ghi 
