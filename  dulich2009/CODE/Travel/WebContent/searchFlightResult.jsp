    ...
    <body>
        <div id="templatemo_maincontainer">
            ...
            <div id="templatemo_right_column">
                ...
                <table  border="1">
                    <tr>
                        <td valign="top"><p align="center"><strong><font color="#FF0000" size="2"><b>DANH SÁCH CÁC CHUYẾN BAY </b></font></strong></p>
                            <p align="center">&nbsp;</p>
                            <table border="1">
                                <tr>
                                    <td align="center" valign="middle" bgcolor="#3366FF"><font color="#FFFFFF" size="2"><strong>Hãng hàng không </strong></font></td>
                                    <td align="center" valign="middle" bgcolor="#3366FF"><font color="#FFFFFF" size="2"><strong>Số hiệu chuyến bay </strong></font></td>
                                    ...
                                    <td align="center" valign="middle" bgcolor="#3366FF"><strong><font color="#FFFFFF" size="2">Hạng dịch vụ</font></strong></td>
                            ...
                            log.info(services);
                             ...
                             out.println("<input type=\"hidden\" name=\"msg\" value=\"" + services + "\"/>");
                                ...
                                <tr bgcolor="#FFFFFF">
                                    ...
                                    <td width="65" align="center" valign="middle"><%=serviceList.get(2) %></td>
                                    <td width="93" align="center" valign="middle"><%=serviceList.get(3) %></td>
                                    <td width="76" align="center" valign="middle"><%=serviceList.get(4) %></td>
                                    <td width="90" align="center" valign="middle"><%=serviceList.get(5) %></td>
                                    <td width="84" align="center" valign="middle"><%=serviceList.get(6) %></td>
                                    <td width="72" align="center" valign="middle"><%=serviceList.get(7) %></td>
