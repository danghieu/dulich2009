                    ...
                    try {
                        ...
                        if (new_ticket != null) {
                            ...
                            if (ind1 != null) {
                                ...
                                isOk = true;
                                respone = "Äáº·t thÃ nh cÃ´ng.";
                                //input_ticketid + c_phone + Message.FIELD_SEPARATE + c_fullname + c_phone + Message.FIELD_SEPARATE + c_fullname + Message.FIELD_SEPARATE + input_ticketid + Message.FIELD_SEPARATE + input_BookNumber + Message.FIELD_SEPARATE + total + tiente;
                            //    System.out.println(respone);
                            } else {
                                respone = "Äáº·t không thÃ nh cÃ´ng.";
