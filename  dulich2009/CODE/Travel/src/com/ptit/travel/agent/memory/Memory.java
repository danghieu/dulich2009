package com.ptit.travel.agent.memory;
...
/**
 * Agent Memory Main functionality to access and manipulate Jena ontology models
 * in MySQL database
 * 
 * @version 0.8
 */
public class Memory {
     ...
     *            name of the agent
     */
    public Memory(String _propertyFile, String _agentName) {
    ...
    public static String getBase() {
        return com.ptit.travel.agent.onto.Config.BASE + "#";
    }
    ...
    public void createModel() {
        ...
        OntModelSpec ontModelSpec = new OntModelSpec(OntModelSpec.OWL_MEM);// _RDFS_INF);

        ontModelSpec.setBaseModelMaker(modelMaker);//setModelMaker();// EDITED by TrungPQ
        ...
        log.debug("reading model from " + com.ptit.travel.agent.onto.Config.SOURCE_FILE);
        model.read(com.ptit.travel.agent.onto.Config.SOURCE_FILE);
            ...
            if (config.MEM_MODEL) {
                ...
                try {
                    ...
                    model.read(new FileInputStream(
                            com.ptit.travel.agent.onto.Config.SOURCE_FILE), Ontology.BASE);
                    log.debug("reading individuals from " + config.INDIVIDUALS_FILE);
                ...
                ontModelSpec.setBaseModelMaker(modelMaker); // setModelMaker() EDITED by TrungPQ 2009-10-05
    ...
    public void reset() {
        ...
        ontModelSpec.setBaseModelMaker(modelMaker); //setModelMaker(
