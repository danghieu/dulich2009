                      ...
                      <tr>
                        <td height="290" align="center" valign="middle"><p class="style3">Xin vui l&ograve;ng nh&#7853;p &#273;&#7847;y &#273;&#7911; th&ocirc;ng tin </p>
                            <table width="310" height="101" border="1">
                              <tr>
                                <td width="102"><span class="style3">Nh&agrave; cung c&#7845;p </span></td>
                                <td width="192"><select name="loainhacungcap" class="style3" id="loainhacungcap">
                                    <option selected="selected" value="hotel">Kh&aacute;ch s&#7841;n</option>
                                    <option value="flight">&#272;&#7841;i l&yacute; b&aacute;n v&eacute; m&aacute;y bay </option>
                                    <option value="train">&#272;&#7841;i l&yacute; b&aacute;n v&eacute; t&agrave;u h&#7887;a </option>
                                </select></td>
                              </tr>
                              <tr>
