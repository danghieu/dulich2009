 ...
 * @author Ariang
 */
public class TrainProcess2 {
private static Logger log = Logger.getLogger(TrainProcess2.class.getName());
...
//        System.out.print("Sau insert Truoc add");
        model.add(ontmodel);
//        System.out.print("Model tong hop");
//        model.write(System.out);
        System.out.print("Sau add");
        ExtendedIterator<?> extendedIterator = cl.listInstances(); // lay tat ca cac the hien cua cai lop day
        System.out.print("Bat dau in ket qua");
        String s = "";
...
public static String printPropertyValues(Individual ind, Property prop) {
    ...
    public static void main(String arg[]) throws Exception{
        TrainProcess2 trainprocess=new TrainProcess2();
    ...
    //    String ss=trainprocess.search(input);
        String ss=trainprocess.printValues("HN_ND_SE1");
