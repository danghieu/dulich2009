...
public class Config {
    ...
    public Config(String propertyFile) {
        ...
        try {
            ...
            CREATE_MODEL = new Boolean(config.getProperty("CREATE_MODEL")).booleanValue();
            REMOVE_MODEL = new Boolean(config.getProperty("REMOVE_MODEL")).booleanValue();
            MEM_MODEL = new Boolean(config.getProperty("MEM_MODEL")).booleanValue();
   ...
   */
	 ...
	 */
    public boolean CREATE_MODEL = true;
	/**
	...
	/**
	 * Individuals file defines path to OWL file containing of agent ontology Individuals (instances)<br>
	...
	/**
	 * Output file defines path to OWL file where content of OM can we write when calling method  {@link agent.core.memory.Memory#memory2owl memory2owl()}  
	 */    
